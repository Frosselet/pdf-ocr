...
class BamlAsyncClient:
    ...
    async def ExtractReportDate(self, raw_value: str,hint: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractReportDate", args={
...
class BamlStreamClient:
    ...
    def ExtractReportDate(self, raw_value: str,hint: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractReportDate", args={
            "raw_value": raw_value,"hint": hint,
        })
...
class BamlHttpRequestClient:
    ...
    async def ExtractReportDate(self, raw_value: str,hint: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractReportDate", args={
            "raw_value": raw_value,"hint": hint,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume: str,
